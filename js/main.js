function main() {
    ...
    if($('#tableContainer')[0]) {
        let data = $.ajax({
            type: "GET",
            url: "https://raw.githubusercontent.com/dental-centre/dental-centre.github.io/master/data/tarief_2025.csv",
    ...
    if($('#tableContainer_en')[0]) {
        let data = $.ajax({
            type: "GET",
            url: "https://raw.githubusercontent.com/dental-centre/dental-centre.github.io/master/data/tarief_2025_en.csv",
            success: function (response) {
